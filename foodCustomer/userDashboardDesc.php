    ...
    <body>
        <div class="prevent_hidden">
            ...
            <div class="user_graph_container2">
                <button type="button" onclick="location.href = './userDashboardAsc.php'"><i class="fa-solid fa-sort fa-2xl" style="color: #000000;"></i></button>
        ...
        <?php
                            ...
                            $DBdata = mysqli_query($connectDB, "SELECT COUNT(DISTINCT orders_id), kiosk_name 
                                                                ...
                                                                GROUP BY kiosk_id 
                                                                ORDER BY COUNT(DISTINCT orders_id) DESC");
                            $countList = 1;
